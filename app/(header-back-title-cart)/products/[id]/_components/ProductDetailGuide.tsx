  ...
  return (
    <div className="self-stretch px-3.5 py-3 bg-Static-White flex flex-col justify-start items-start gap-3">
      <div className="flex flex-col justify-start items-start gap-1">
        <p className="justify-start text-Label-Normal title2-sb">체험 가이드</p>
      ...
      <div className="self-stretch flex flex-col justify-start items-start gap-2">
        <div className="inline-flex justify-start items-start gap-2.5">
          <p className="justify-start text-Label-Alternative body2-m">
            체험 구성품
          </p>
        </div>
        <div className="self-stretch inline-flex justify-between items-center">
          <div className="w-14 h-14 flex flex-col justify-center items-center gap-1">
            ...
            <p className="text-center justify-center text-Label-Subnormal caption-m">
              보관 가방
            </p>
          </div>
          <div className="w-14 h-14 flex flex-col justify-center items-center gap-1">
